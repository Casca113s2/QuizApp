...
{
    class StudentHomeBLL
    {
        private Button currentButton;
        string currentForm;
        private Random random;
        private int tempIndex;
        GUI.frmStudentHome frmStudentHome;

        public StudentHomeBLL(GUI.frmStudentHome frmStudentHome)
        {
            random = new Random();
            this.frmStudentHome = frmStudentHome;
            currentForm = "";
        }
        ...
        private void ActivateButton(object btnSender)
        {
            if (btnSender != null)
            {
                if (currentButton != (Button)btnSender)
                {
                    ...
                    frmStudentHome.PanelTitleBar.BackColor = color;
                    frmStudentHome.PanelLogo.BackColor = ThemeColor.ChangeColorBrightness(color, -0.3);
                }
            }
        }
        ...
        {
            foreach (Control previousBtn in frmStudentHome.PanelMenu.Controls)
            {
        ...
        private void deletePanelControls()
        {
            ...
            foreach (Control c in frmStudentHome.PanelMain.Controls)
                c.Dispose();
        }
        ...
        public void actionButtonClick(object sender, Form targetForm)
        {
            ...
            if (createForm)
            {
                ...
                frmStudentHome.LabelTitle.Text = targetForm.Text;
                targetForm.Closed += (s, args) =>
                {
                    currentForm = "";
                    frmStudentHome.LabelTitle.Text = "Home";
                    frmStudentHome.PanelMain.Controls.Clear();
                    DisableButton();
                };
                ...
                frmStudentHome.PanelMain.Controls.Add(targetForm);
                targetForm.Show();
        ...
        public void closeStudentHomeFrom(FormClosingEventArgs e)
        {
